    ...
    <div class="login-box">
        ...
        <div class="card shadow-sm">
            ...
            <div class="btn-group w-100">
                <a class="btn btn-default w-50 " href="{{ url()->previous() }}"> <i
                        class="fas fa-arrow-circle-left mx-3"></i>{{ trans('error.back') }}</a>
                <a class="btn btn-default w-50 " href="{{ route('users.profile') }}"> <i
                        class="fas fa-user-circle mx-3"></i>{{ trans('error.back_to_home') }}</a>
            </div>
            <!-- /.login-card-body -->
        </div>
    </div>
