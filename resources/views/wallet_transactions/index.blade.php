...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-md-row flex-column-reverse align-items-start card-header-tabs">
                    <div class="d-flex flex-row">
                        ...
                        @can('walletTransactions.create')
                            <li class="nav-item">
                                <a class="nav-link" href="{!! route('walletTransactions.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.wallet_transaction_create')}}
                                </a>
                            </li>
                        @endcan
                    </div>
            ...
            <div class="card-body">
                @include('wallet_transactions.table')
                <div class="clearfix"></div>
            </div>
        </div>
    </div>
