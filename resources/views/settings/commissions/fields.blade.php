...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('commission', trans('lang.e_provider_type_commission'), [
...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            {!! Form::select('type', ['1' => trans('lang.tax_percent'), '0' => trans('lang.tax_fixed')], null, [
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            {!! Form::select('commission_from', ['1' => trans('lang.garage'), '0' => trans('lang.user')], null, [
                'class' => 'select2 form-control',
            ]) !!}
            <div class="form-text text-muted"></div>
        </div>
