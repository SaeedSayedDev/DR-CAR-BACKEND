        ...
        <tbody>
            @foreach ($dataTable as $commission)
                <tr>
                    ...
                    <td>
                        <span
                            class="badge bg-primary">{{ $commission->type ? trans('lang.tax_percent') : trans('lang.tax_fixed') }}</span>
                    </td>
                    <td>
                        <span
                            class="badge bg-primary">{{ $commission->commission_from ? trans('lang.garage') : trans('lang.user') }}</span>
                    </td>
